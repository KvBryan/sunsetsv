                  ...
                  if (widget!.tripRef?.complete ?? true)
                    Column(
                      ...
                      children: [
                        Text(
                          FFLocalizations.of(context).getText(
                            'hh47enm9' /* Tu vacación está completada! */,
                          ),
                          style:
                      ...
                      Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'mo1kgpyz' /* Información del Anfitrión */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
