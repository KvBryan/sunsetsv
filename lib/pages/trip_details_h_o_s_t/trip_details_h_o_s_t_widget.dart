                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                '8bk2yuw8' /* Marque esta vacación como comp... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .titleMedium
                                  .override(
                          ...
                          Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '8hc5y4wr' /* Información del Huésped */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
